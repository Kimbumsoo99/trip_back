...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b43c988c5170c66105dad16e5cb282d1&libraries=services"></script>
<script
	...
	<main>
		...
		<div class="container">
			...
			<form class="d-flex my-3" onsubmit="return false;" role="search">
				...
				</select> <select id="search-area-2" class="form-select me-2">
				...
				<button id="btn-search" class="btn btn-outline-success"
					type="button" onclick="getTouristSpots()">
